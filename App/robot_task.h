...
#ifdef ATTITUDE_COM_SWITCH
    /* 串口姿态互传任务 */
    const osThreadAttr_t Attitude_Communication_attributes = 
    {
        .name = "Attitude_Communication_Task",
        .stack_size = 256 * 4 ,
        .priority = (osPriority_t) osPriorityNormal,
    };
    AttitudeCommunication_TaskHandle = osThreadNew(Attitude_Communication_Task, NULL, &Attitude_Communication_attributes);
#endif
