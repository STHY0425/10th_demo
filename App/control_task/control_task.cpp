...
{
    if(xbox_chassis_data.joyLHori -32768 >3000 || xbox_chassis_data.joyLHori - 32768 < -3000)ctrl_data.linear_x = (xbox_chassis_data.joyLHori - 32767) / 32767.0f * MAX_VELOCITY;
  else ctrl_data.linear_x = 0;

  if(xbox_chassis_data.joyLVert -32768 >3000 || xbox_chassis_data.joyLVert - 32768 < -3000)ctrl_data.linear_y = -(xbox_chassis_data.joyLVert - 32767) / 32767.0f * MAX_VELOCITY;
  else ctrl_data.linear_y = 0;

  if(xbox_chassis_data.joyRHori -32768 >3000 || xbox_chassis_data.joyRHori - 32768 < -3000)ctrl_data.Omega = (xbox_chassis_data.joyRHori - 32767) / 32767.0f * MAX_ANGLE_VELOCITY;
