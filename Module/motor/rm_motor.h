...
#if 0          
          g_trace[this->ID*2-1] = this->ctrl_motor_config.motor_controller_setting.pid_ref;
          g_trace[this->ID*2-2] = this->speed_aps;
          VOFA_SendFloat(vofa_instance,g_trace[2]);
          VOFA_SendFloat(vofa_instance,g_trace[3]);
          VOFA_SendEND(vofa_instance);
          g_trace_pid[this->ID-1] = this->ctrl_motor_config;
        //   this->ctrl_motor_config.motor_controller_setting.speed_PID.Kp =\
        //                                         vofa_instance->pub_data.Kp;
        //   this->ctrl_motor_config.motor_controller_setting.speed_PID.Ki =\
        //                                         vofa_instance->pub_data.Ki;       
        //   this->ctrl_motor_config.motor_controller_setting.speed_PID.Kd =\
        //                                         vofa_instance->pub_data.Kd; 
        //   this->ctrl_motor_config.motor_controller_setting.speed_PID.IntegralLimit =\
        //                                         vofa_instance->pub_data.i_limit; 
        
        
 //   VOFA_SendFloat(vofa_instance,1.1);
        //   VOFA_SendEND(vofa_instance);
    //           /* 发送数据到 VOFA */
    // VOFA_SendFloat(vofa_instance, g_trace[3]);       // 发送参考值
    // VOFA_SendFloat(vofa_instance, g_trace[2]);  // 发送测量值
